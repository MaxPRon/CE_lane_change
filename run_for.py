...
image_save_path = './short_2/model_initial/Plots/'
...
ax1.grid()
plt.savefig(image_save_path + str(num_of_episodes) + "_trajectory.png")
...
plt.tight_layout()
plt.savefig(image_save_path + str(num_of_episodes) + "_behaviour.png")
plt.show(block=False)
#plt.show(block=False)
...
plt.savefig(image_save_path + str(num_of_episodes) + "_reward.png")
plt.show(block=False)
#plt.show()
...
plt.savefig(image_save_path + str(num_of_episodes) + "_Q_values.png")
#plt.show(block=False)
plt.show()
